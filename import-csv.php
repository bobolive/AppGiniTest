<?php
	...
	$transformFunctions = [
		'Projects' => function($data, $options = []) {
			if(isset($data['Category'])) $data['Category'] = pkGivenLookupText($data['Category'], 'Projects', 'Category');

			return $data;
		},
		'Tags' => function($data, $options = []) {
	...
	$filterFunctions = [
		...
		'Tags' => function($data, $options = []) { return true; },
