		...
		$pcConfig = [
			'Projects' => [
				'Category' => [
					...
					'tab-label' => 'Category type <span class="hidden child-label-Projects child-field-caption">(Category)</span>',
					'auto-close' => false,
					'table-icon' => 'resources/table_icons/house.png',
					'display-refresh' => true,
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => [1 => 'Project\'s name', 2 => 'Description', 3 => 'Category', 4 => 'ProjectTags', 5 => 'Image 1', 6 => 'Image Uploaded', 7 => 'Google place'],
					'display-field-names' => [1 => 'Projects_name', 2 => 'Description', 3 => 'Category', 4 => 'ProjectTags', 5 => 'Image_1', 6 => 'Image_Uploaded', 7 => 'Geo_place'],
					'sortable-fields' => [0 => '`Projects`.`id`', 1 => 2, 2 => 3, 3 => '`Categories1`.`Category_name`', 4 => 5, 5 => 6, 6 => 7, 7 => '`Projects`.`Geo_place`'],
					'records-per-page' => 10,
