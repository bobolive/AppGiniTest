	...
	*/
		...
		$all_tables = [
			/* ['table_name' => [table props assoc array] */   
				...
				'Tags' => [
					'Caption' => 'Tags',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/layer_label.png',
					'group' => $tg[0],
					'homepageShowCount' => 0
				],
				'Categories' => [
	...
	function getTableList($skip_authentication = false) {
		...
		$arrTables = [
			...
			'Projects' => ['Projects', '', 'resources/table_icons/house.png', 'None'],
			'Tags' => ['Tags', '', 'resources/table_icons/layer_label.png', 'None'],
			'Categories' => ['Categories', '', 'resources/table_icons/barchart.png', 'None'],
		];
	...
	function getThumbnailSpecs($tableName, $fieldName, $view) {
		if($tableName=='Projects' && $fieldName=='Image_1' && $view=='tv')
			return ['width'=>50, 'height'=>50, 'identifier'=>'_tv'];
		elseif($tableName=='Projects' && $fieldName=='Image_1' && $view=='dv')
			return ['width'=>800, 'height'=>800, 'identifier'=>'_dv'];
		return FALSE;
	}
	########################################################################
	...
	*/
	...
	function lookupQuery($tn, $lookupField) {
		...
		*/
		$lookupQuery = [
			'Projects' => [
				'Category' => 'SELECT `Categories`.`id`, `Categories`.`Category_name` FROM `Categories` ORDER BY 2',
			],
			'Tags' => [
			],
			'Categories' => [
